...
- **Application Release Version**: `v0.25.0-rc1`
- **Release Stage**: Release Candidate — Code Verified (localhost runtime evidence; infra/provider blocked)
- **Git Commit SHA**: `9586de2`
- **Git Branch**: `main`
- **Build Timestamp**: `2026-09-13T09:30:00.000Z`
...
| **Test Suites** | Jest 29 / ts-jest | `backend/src/**/__tests__` | **PASS** (42 suites, 493 tests, 57.2s) | 100% Passing (0 failures) — includes Day 25 staging-release-candidate suite |
