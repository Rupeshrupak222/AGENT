      ...
      <section aria-label="Executive Telemetry Strip">
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-2.5 sm:gap-3">
          ...
          <ExecutiveKpiCard
            ...
            label="Calls Handled"
            theme="sky"
            icon={<PhoneCall className="w-4.5 h-4.5 text-sky-500" />}
          ...
          <ExecutiveKpiCard
            ...
            label="AI Minutes"
            theme="violet"
            icon={<Timer className="w-4.5 h-4.5 text-violet-500" />}
          ...
          <ExecutiveKpiCard
            ...
            label="Qualified Leads"
            theme="purple"
            icon={<Target className="w-4.5 h-4.5 text-purple-500" />}
          ...
          <ExecutiveKpiCard
            ...
            theme="brand"
            icon={<Brain className="w-4.5 h-4.5 text-brand-500 dark:text-brand-400" />}
            value={
              <>
