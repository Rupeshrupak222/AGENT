...
export function SuperAdminView({
  ...
  const [agentLanguageFilter, setAgentLanguageFilter] = useState<"all" | "english" | "hindi" | "telugu">("all");
  ...
  // ── Agent Language Counts ──────────────────────────────────────────
  const agentLanguageCounts = useMemo(() => {
    return {
      all: platformAgents.length,
      english: platformAgents.filter((a) => a.language === "english").length,
      hindi: platformAgents.filter((a) => a.language === "hindi").length,
      telugu: platformAgents.filter((a) => a.language === "telugu").length,
    };
  }, [platformAgents]);
  ...
  const filteredAgents = useMemo(() => {
    return platformAgents.filter((a) => {
      ...
      const matchesLanguage =
        agentLanguageFilter === "all" ? true : a.language === agentLanguageFilter;
      return matchesSearch && matchesCompany && matchesStatus && matchesLanguage;
    });
  }, [platformAgents, agentSearch, agentCompanyFilter, agentStatusFilter, agentLanguageFilter]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-amber-500/25 bg-gradient-to-br from-amber-500/10 via-brand-500/10 to-orange-500/10 dark:from-[#120a06] dark:via-[#1a0f08] dark:to-[#0d0704] p-6 shadow-xl dark:shadow-2xl dark:shadow-black/60">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2.5">
              <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-amber-500/20 border border-amber-500/40 text-amber-600 dark:text-amber-400">
                <ShieldCheck className="h-4 w-4" />
              </span>
              <span className="text-[11px] font-black uppercase tracking-wider text-amber-600 dark:text-amber-400">
                Super Admin Console
              </span>
              <span className="rounded-md bg-emerald-500/10 border border-emerald-500/20 px-2 py-0.5 text-[10px] font-bold text-emerald-600 dark:text-emerald-400 flex items-center gap-1">
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" />
                Live Multi-Tenant Cloud
              </span>
            </div>
            <h1 className="mt-2 text-2xl md:text-3xl font-black tracking-tight text-slate-900 dark:text-white">
          ...
          <div className="flex items-center gap-2.5 flex-shrink-0">
            <button
              ...
              className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 text-xs font-semibold text-slate-800 dark:text-white transition-all disabled:opacity-50"
            >
              <RefreshCw
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-xs font-black text-white shadow-lg shadow-amber-900/20 border border-amber-400/30 transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3.5">
        ...
        <div className="rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#120a06]/80 p-4 relative overflow-hidden shadow-sm">
        ...
        <div className="rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#120a06]/80 p-4 relative overflow-hidden shadow-sm">
          ...
          <div className="mt-1 text-[10px] text-purple-600/80 dark:text-purple-300/70 font-semibold">
        ...
        <div className="rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#120a06]/80 p-4 relative overflow-hidden shadow-sm">
          ...
          <div className="mt-1 text-[10px] text-blue-600/80 dark:text-blue-300/70 font-semibold">
            Inbound & Outbound
          </div>
        </div>
        ...
        <div className="rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#120a06]/80 p-4 relative overflow-hidden shadow-sm">
          ...
          <div className="mt-1 text-[10px] text-amber-600/80 dark:text-amber-300/70 font-semibold">
            Minutes Burned
          </div>
        </div>
        ...
        <div className="rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#120a06]/80 p-4 relative overflow-hidden shadow-sm">
          ...
          <div className="mt-1 text-[10px] text-emerald-600/80 dark:text-emerald-300/70 font-semibold">
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all whitespace-nowrap ${
                isActive
                  ? "bg-amber-600 text-white shadow-md shadow-amber-950/30 border border-amber-500/30"
              ...
              {tab.badge !== null && (
                <span
                  className={`px-1.5 py-0.5 rounded-full text-[10px] font-black ${
                    isActive ? "bg-white/20 text-white" : "bg-slate-200 dark:bg-white/10 text-slate-700 dark:text-white/60"
                  }`}
                >
                  {tab.badge}
                </span>
      ...
      {activeTab === "companies" && (
        <div className="space-y-4">
          {/* Controls Bar */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-slate-100/80 dark:bg-[#120a06]/60 p-3 rounded-xl border border-slate-200 dark:border-white/10">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full bg-white dark:bg-black/40 border border-slate-200 dark:border-white/10 rounded-xl pl-9 pr-3 py-1.5 text-xs text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-white/40 focus:outline-none focus:border-amber-500"
              />
            </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <select
                ...
                className="bg-white dark:bg-black/40 border border-slate-200 dark:border-white/10 rounded-xl px-3 py-1.5 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-amber-500"
              >
          ...
          {/* Companies Table */}
          <div className="overflow-hidden rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#120a06]/90 shadow-xl">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs text-slate-700 dark:text-white/80">
                <thead className="bg-slate-50 dark:bg-[#1a0f08] border-b border-slate-200 dark:border-white/10 text-[11px] font-bold text-slate-500 dark:text-white/50 uppercase tracking-wider">
                  <tr>
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-white/5">
                  {filteredTenants.length === 0 ? (
                    <tr>
                      <td colSpan={8} className="py-12 text-center text-slate-400 dark:text-white/40">
                        <Building2 className="h-8 w-8 mx-auto mb-2 opacity-40 text-amber-500" />
                    ...
                    filteredTenants.map((tenant) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-3 px-4">
                            <div className="flex items-center gap-1.5">
                              ...
                              <button
                                ...
                                className="text-slate-400 dark:text-white/30 hover:text-amber-500 transition-colors p-1"
                              >
                          ...
                          <td className="py-3 px-4 text-center font-semibold text-slate-700 dark:text-white/80">
                            {tenant._count?.users || 0}
                          </td>

                          <td className="py-3 px-4 text-center font-semibold text-purple-600 dark:text-purple-300">
                            {tenant._count?.agents || 0}
                          </td>

                          <td className="py-3 px-4 text-center font-semibold text-blue-600 dark:text-blue-300">
                          ...
                          <td className="py-3 px-4 text-right">
                            <div className="flex items-center justify-end gap-1.5">
                              <button
                                ...
                                className="px-2.5 py-1 rounded-lg bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 text-[11px] font-semibold text-slate-700 dark:text-white transition-all"
                              >
                                Details
                              </button>
                ...
                <span
                  className={`px-1.5 py-0.5 rounded-md text-[10px] font-mono ${
                    agentLanguageFilter === tab.id
                      ...
                      : "bg-slate-200 dark:bg-white/10 text-slate-700 dark:text-white/50"
                  }`}
                >
                  {tab.count}
                </span>
                        ...
                        >
                          <td className="py-3 px-4">
                            <div className="font-bold text-slate-900 dark:text-white text-sm flex items-center gap-1.5">
                              <Bot className="h-4 w-4 text-purple-500 dark:text-purple-400 flex-shrink-0" />
                              {agent.name}
                            </div>
                            ...
                            <span
                              className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold border ${
                                agent.status === "active"
                                  ...
                                  : "bg-slate-100 dark:bg-white/10 text-slate-600 dark:text-white/60 border-slate-200 dark:border-white/20"
                              }`}
                            >
                              <span
                                className={`h-1.5 w-1.5 rounded-full ${
      ...
      {activeTab === "billing" && (
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-amber-500/20 bg-white dark:bg-[#120a06] p-5 shadow-xl">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4 text-xs">
                <div>
                  <span className="text-slate-400 dark:text-white/40 block text-[10px] uppercase font-bold">
                    Platform MRR
                  </span>
                      ...
                      >
                        ...
                        <td className="py-3 px-4">
                          <div className="space-y-1">
                            <div className="flex items-center justify-between text-[10px] font-bold">
                              ...
                              {isOverLimit && (
                                <span className="text-rose-600 dark:text-rose-400 text-[9px] uppercase">
                                  Over Quota
                                </span>
                              )}
                            </div>
                        ...
                        <td className="py-3 px-4 text-right">
                          <button
                            ...
                            className="px-2.5 py-1 rounded-lg bg-amber-600/10 hover:bg-amber-600/20 dark:bg-amber-600/20 dark:hover:bg-amber-600/30 border border-amber-500/30 text-amber-700 dark:text-amber-300 text-[11px] font-semibold transition-all"
                          >
                            Change Plan
                          </button>
                        </td>
      ...
      {activeTab === "statistics" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#120a06]/90 p-5 shadow-xl">
              ...
              {[...tenants]
                ...
                .map((tenant, idx) => {
                  ...
                  return (
                    <div
                      key={tenant.id}
                      className="flex items-center justify-between p-2.5 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200/80 dark:border-white/5"
                    >
                      <div className="flex items-center gap-2.5">
                        <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-amber-500/10 dark:bg-white/10 text-xs font-black text-amber-600 dark:text-amber-400">
                          #{idx + 1}
                        </span>
                        <div>
        ...
        {isCreateModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <motion.div
              ...
              className="w-full max-w-md rounded-2xl border border-slate-200 dark:border-amber-500/30 bg-white dark:bg-[#140b07] p-6 shadow-2xl"
            >
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/10 pb-3">
                ...
                <button
                  ...
                  className="text-slate-400 dark:text-white/40 hover:text-slate-700 dark:hover:text-white"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
              ...
              <form onSubmit={handleCreateCompany} className="mt-4 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 px-3 py-2 text-xs text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-white/30 focus:border-amber-500 focus:outline-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 px-3 py-2 text-xs text-slate-900 dark:text-white focus:border-amber-500 focus:outline-none"
                  >
                ...
                <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-200 dark:border-white/10">
                  <button
                    type="button"
                    onClick={() => setIsCreateModalOpen(false)}
                    className="px-3 py-1.5 rounded-xl text-xs text-slate-600 dark:text-white/60 hover:text-slate-900 dark:hover:text-white"
                  >
                    Cancel
                  </button>
                  <button
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            ...
            >
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="p-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-xs text-slate-600 dark:text-white/60">
        ...
        {isDetailDrawerOpen && (
          <div className="fixed inset-0 z-50 flex justify-end bg-black/70 backdrop-blur-sm">
            <motion.div
              ...
              className="w-full max-w-xl h-full bg-white dark:bg-[#120a06] border-l border-slate-200 dark:border-white/15 p-6 overflow-y-auto shadow-2xl"
            >
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/10 pb-4">
                ...
                <button
                  ...
                  className="p-1.5 rounded-xl bg-slate-100 dark:bg-white/5 text-slate-500 dark:text-white/50 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-white/10"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
                ...
                <div className="mt-6 space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div className="p-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10">
                      <div className="text-xs text-slate-500 dark:text-white/40 font-bold">Team Members</div>
                      <div className="text-lg font-black text-slate-900 dark:text-white mt-1">
                        {selectedTenantDetails._count?.users || 0}
                      </div>
                    </div>
                    <div className="p-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10">
                      <div className="text-xs text-slate-500 dark:text-white/40 font-bold">AI Agents</div>
                      <div className="text-lg font-black text-purple-600 dark:text-purple-400 mt-1">
                        {selectedTenantDetails._count?.agents || 0}
                      </div>
                    </div>
                    <div className="p-3 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10">
                      <div className="text-xs text-slate-500 dark:text-white/40 font-bold">Total Calls</div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1.5">
                      {(selectedTenantDetails.users || []).length === 0 ? (
                        <div className="text-xs text-slate-400 dark:text-white/40 p-3 rounded-xl bg-slate-50 dark:bg-white/[0.02]">
                        ...
                        (selectedTenantDetails.users || []).map((u) => (
                          <div
                            key={u.id}
                            className="flex items-center justify-between p-2.5 rounded-xl bg-slate-50 dark:bg-white/[0.02] border border-slate-200/80 dark:border-white/5 text-xs"
                          >
                            <div>
                              <div className="font-semibold text-slate-900 dark:text-white">{u.name}</div>
                              <div className="text-[11px] text-slate-500 dark:text-white/40">{u.email}</div>
                            </div>
                            <span className="px-2 py-0.5 rounded-md bg-slate-200 dark:bg-white/10 text-slate-700 dark:text-white/70 text-[10px] font-mono capitalize">
                              {u.role}
                            </span>
                          </div>
                        ))
                    ...
                    <div className="space-y-1.5">
                      {(selectedTenantDetails.agents || []).length === 0 ? (
                        ...
                        (selectedTenantDetails.agents || []).map((ag) => (
                          ...
                          >
                            <div>
                              <div className="font-semibold text-slate-900 dark:text-white">{ag.name}</div>
                              <div className="text-[11px] text-slate-500 dark:text-white/40">
