      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header className="h-16 flex items-center justify-between px-4 sm:px-6 flex-shrink-0 z-30 border-b border-slate-200 dark:border-brand-500/15 bg-surface-sidebar/85 backdrop-blur-xl transition-colors duration-200">
          <div className="flex items-center gap-3 min-w-0">
            ...
            {/* Workspace switcher with Environment indicator */}
            <div className="relative" onClick={(e) => e.stopPropagation()}>
              <button
                ...
                className="hidden sm:flex items-center gap-2 px-3 h-9 rounded-lg bg-slate-100/70 dark:bg-white/[0.04] hover:bg-slate-100 dark:hover:bg-white/[0.08] border border-slate-200 dark:border-white/10 transition-all"
              >
                ...
                <EnvironmentBadge mode={process.env.NODE_ENV === "production" ? "LIVE" : "SANDBOX"} className="hidden xl:inline-flex" />
              ...
              <AnimatePresence>
                {workspaceOpen && (
                  <motion.div
                    ...
                    className="absolute left-0 top-12 w-72 rounded-xl overflow-hidden z-50 bg-dropdown border border-slate-200 dark:border-white/10 backdrop-blur-xl shadow-2xl"
                  >
                    <div className="px-4 py-3 border-b border-slate-200 dark:border-white/[0.06] flex items-center justify-between">
                      <p className="text-[11px] font-semibold text-slate-500 dark:text-white/40 uppercase tracking-wide">
                        Workspace & Cluster
                      </p>
                      <EnvironmentBadge mode={process.env.NODE_ENV === "production" ? "LIVE" : "SANDBOX"} />
                    </div>
                    <div className="px-2 py-2">
                      <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-indigo-500/10 border border-indigo-500/20">
                        <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm bg-indigo-600 text-white font-bold">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-0.5 text-[10px] text-slate-500 dark:text-white/50">
                            <span className="capitalize">{tenant?.plan || "Growth"} Tier</span>
                            <span>•</span>
                            <span className="font-mono">Cluster 04</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="px-2 pb-2">
                      <Link
                        ...
                        className="flex items-center justify-between px-3 py-2 text-xs font-medium text-slate-700 dark:text-white/70 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-slate-100 dark:hover:bg-white/[0.04] rounded-lg transition-all"
                      >
        ...
        <nav aria-label="Mobile navigation" className="lg:hidden h-14 bg-surface-sidebar/95 backdrop-blur-md border-t border-slate-200 dark:border-white/10 flex items-center justify-around px-2 z-20 flex-shrink-0">
          <Link
            href="/dashboard/overview"
            className={cn(
              "flex flex-col items-center justify-center gap-1 py-1 px-2 text-[10px] transition-colors",
