  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-8">
      ...
      <div className="rounded-2xl p-6 bg-white dark:bg-gradient-to-b dark:from-white/[0.06] dark:to-white/[0.02] border border-slate-200 dark:border-white/[0.08] shadow-2xl space-y-4">
        ...
        {loading ? (
          <div className="flex items-center justify-center gap-2 py-12 text-slate-400 dark:text-white/40 text-sm">
                ...
                <div className="flex items-center gap-4">
                  <span className={`text-xs font-semibold px-2.5 py-0.5 rounded-full capitalize ${
                    member.role === "company_admin"
                      ...
                      : member.role === "viewer"
                      ? "bg-slate-100 dark:bg-white/10 text-slate-600 dark:text-white/60 border border-slate-200 dark:border-white/15"
            ...
            <form onSubmit={handleInvite} className="space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-2">
                <button
                  ...
                  disabled={inviting}
                  className="px-4 py-2 rounded-xl text-xs font-semibold bg-slate-100 dark:bg-white/[0.05] text-slate-600 dark:text-white/60 hover:text-slate-900 dark:hover:text-white disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
