...
export default function BillingPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
      ...
      {/* Usage Meter Card */}
      <div className="rounded-2xl p-6 bg-[#150305]/90 bg-gradient-to-b from-white/[0.06] to-white/[0.02] border border-white/[0.08] shadow-2xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {Object.entries(PLANS_DISPLAY).map(([key, info]) => {
            ...
            return (
              <div
                key={key}
                className={`relative flex flex-col justify-between rounded-2xl p-6 bg-[#150305]/90 bg-gradient-to-b from-white/[0.06] to-white/[0.02]"border-brand-500/50 shadow-2xl shadow-brand-950/40 ring-1 ring-brand-500/30"
                    : isCurrent
                    ? "border-emerald-500/40 shadow-xl"
                    : "border-white/[0.08] hover:border-white/15 dark:hover:border-white/20"
                }`}
              >
                {info.popular && (
