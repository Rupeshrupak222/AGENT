  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm">
      ...
      >
        ...
        <div className="px-4 py-2 bg-slate-100/80 dark:bg-black/40 border-b border-slate-200 dark:border-white/[0.06] flex items-center justify-between text-[11px] font-mono flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            {lastMetrics && (
              <span className="text-slate-500 dark:text-white/40 hidden sm:inline">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-emerald-600 dark:text-emerald-400 font-semibold">Ready for Voice Input</span>
          </div>
        </div>
