  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 backdrop-blur-sm animate-in fade-in">
      <div className="relative w-full max-w-4xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh] text-slate-900 dark:text-white">
        ...
        {/* Header */}
        <div className="px-6 py-5 border-b border-slate-200 dark:border-white/10 flex items-center justify-between bg-purple-50/70 dark:bg-gradient-to-r dark:from-purple-900/30 dark:via-slate-900 dark:to-brand-950/30">
          <div className="flex items-center gap-3">
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-lg font-black text-slate-900 dark:text-white tracking-tight">AI Voice Clone Studio & Persona Forge</h2>
        ...
        {/* Step Navigation */}
        <div className="px-6 pt-4 pb-2 border-b border-slate-200 dark:border-white/10 flex gap-2 bg-slate-50/80 dark:bg-slate-950/40">
          {[
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl text-xs font-semibold transition-all ${
                  isActive
                    ...
                    : "text-slate-600 dark:text-white/40 hover:text-slate-900 dark:hover:text-white/70 hover:bg-slate-200/60 dark:hover:bg-white/5 border border-transparent"
                }`}
              >
          ...
          {activeStep === "source" && (
            <div className="space-y-6 animate-in fade-in">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-semibold text-slate-700 dark:text-white/70 block mb-1.5">Cloned Voice Persona Name</label>
                  <input
                    type="text"
                    value={voiceName}
                    onChange={(e) => setVoiceName(e.target.value)}
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/15 text-sm text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-purple-500 shadow-xs"
                    placeholder="e.g. Maya — Real Estate Advisor"
                  />
                </div>
                <div>
                  <label className="text-xs font-semibold text-slate-700 dark:text-white/70 block mb-1.5">Brand Role / Department</label>
                  <input
                    type="text"
                    value={brandRole}
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className={`p-5 rounded-2xl border transition-all flex flex-col items-center text-center justify-between min-h-[220px] ${
                  ...
                  <div className="w-full flex items-center justify-between text-xs text-slate-500 dark:text-white/50">
                    <span className="flex items-center gap-1.5 font-semibold text-slate-800 dark:text-white/80">
                      <Mic className="w-3.5 h-3.5 text-rose-500 dark:text-rose-400" /> Live Studio Mic
                    </span>
