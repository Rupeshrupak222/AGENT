...
export function CommandPalette({
  ...
  const allCommands: CommandItem[] = useMemo(() => {
    const items: CommandItem[] = [
      ...
      {
        id: "nav-knowledge",
        label: "Knowledge Base & RAG Indexing",
        category: "Navigation",
        icon: FileText,
        href: "/dashboard/knowledge",
        permission: PERMISSIONS.AI_KNOWLEDGE_MANAGE,
      },
      {
        id: "nav-numbers",
        label: "Phone Numbers & SIP Trunks",
        category: "Navigation",
        icon: Phone,
        href: "/dashboard/numbers",
        permission: PERMISSIONS.TELEPHONY_MANAGE,
      },
      {
        id: "nav-integrations",
        label: "Integrations & Provider Handshake",
        category: "Navigation",
        icon: Radio,
      ...
      {
        id: "nav-settings",
        label: "Company Settings & Governance",
        category: "Navigation",
        icon: Settings,
      ...
      {
        id: "sa-telephony",
        label: "Telephony & Number Pool",
        category: "Platform Governance",
        icon: RadioTower,
        href: "/dashboard/admin/telephony",
        badge: "Governance",
        roleRequired: "super_admin",
      },
      {
