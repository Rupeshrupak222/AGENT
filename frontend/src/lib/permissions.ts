...
const ROLE_PERMISSIONS: Record<string, readonly Permission[]> = {
  ...
  company_admin: [
    ...
    PERMISSIONS.CAMPAIGN_VIEW, PERMISSIONS.CAMPAIGN_CREATE, PERMISSIONS.CAMPAIGN_UPDATE, PERMISSIONS.CAMPAIGN_DELETE, PERMISSIONS.CAMPAIGN_EXECUTE, PERMISSIONS.CAMPAIGN_PAUSE,
